...
console.log(`${tRex.name} weighed ${tRex.weight}kg.`);

// What was the diet of a velociraptor?
console.log(`${vRaptor.name} has a ${vRaptor.diet} diet.`);

// How long was a stegosaurus?
console.log(`${steg.name} was ${steg.length}m long.`);

// What time period did tyrannosaurus live in?
console.log(`${tRex.name} lived during the ${tRex.period} period.`);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`${tRex.name} roars, '${tRex.roar()}'`);
